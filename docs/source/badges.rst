|PyPi Version| |Downloads| |Build Status| |Coverage Status| |Requirements Status| |Development Status| |License|
...
.. |Development Status| image:: http://img.shields.io/:status-beta-yellowgreen.svg
